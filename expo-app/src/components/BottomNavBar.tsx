...
export default function BottomNavBar({ activeTab, onTabChange, isDarkMode }: BottomNavBarProps) {
  const tabs: { id: string; label: string; icon: keyof typeof Ionicons.glyphMap; activeIcon: keyof typeof Ionicons.glyphMap }[] = [
